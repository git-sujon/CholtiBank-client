...
export const featuresData = [
  {
    ...
    icon: <MdOutlineDevices className="size-10" />,
  },
  {
    id: 2,
    ...
    icon: <MdSecurity className="size-10" />,
  },
  {
    id: 3,
    ...
    icon: <MdCreditCard className="size-10" />,
  },
  {
    id: 4,
    ...
    icon: <MdTimeline className="size-10" />,
  },
  {
    id: 5,
    ...
    icon: <MdBackup className="size-10" />,
  },
  {
    id: 6,
    title: "E-Statements",
    ...
    icon: <MdReceipt className="size-10" />,
  },
  {
    id: 7,
...

  {
    ...
    icon: <MdMonetizationOn className="size-10"  />,
  },
];
